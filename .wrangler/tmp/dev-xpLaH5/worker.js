...
// .wrangler/tmp/bundle-2KvLAH/strip-cf-connecting-ip-header.js
  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/api/getAllSongs") {
      ...
      const songs = songList.objects.map((song) => ({
        id: song.name,
        name: song.name,
        url: `${publicUrl}/${song.name}`,
        // ✅ Constructs public song URL
        size: song.size
      }));
...
// .wrangler/tmp/bundle-2KvLAH/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-2KvLAH/middleware-loader.entry.ts
